...
const SYSTEM = "You are an elite real estate sales coach. Respond with ONLY a raw valid JSON object. Start with { end with }. No markdown. No backticks. No explanation." const initState = (lang) => ({
 ...
 introSource:[], introComeAcross:[],
  introSourceContext:"", leadSourceContext:"", buyerProfileOther:"", sellerProfileOther:"", expiredReasonsOther:"",
...
function BuyerProfileBox({ s, update, tog }) {
 ...
 <Chips label="Buyer Profile" options={[
      ...
      <div style={{marginBottom:"12px"}}>
        ...
        <input type="text" placeholder="e.g. Needs to complete purchase before school term starts..." style={inp} value={s.buyerProfileOther||""} onChange={e=>update({buyerProfileOther:e.target.value})}/>
      </div>

 <div style={{marginBottom:"14px"}}>
 <label style={lbl}>What Are They Looking For & Why?</label>
 <textarea placeholder="e.g. 3-bed house with garden near good schools, wants to upsize because they are starting a family, needs a home office, prefers a quiet area close to transport..." rows={3} style={{...inp,resize:"vertical",marginTop:"6px"}} value={s.buyerWhatLookingFor||""} onChange={e=>update({buyerWhatLookingFor:e.target.value})}/>
 </div>
...
FULL SITUATION: "${objSituation}" You are an elite real estate sales coach trained in Grant Cardone and Ryan Serhant methodology.
...
{"v1_label":"Data & Market Proof","v1_whatsapp":"60-80 words. Specific, data-backed, personal. Ends with open question.","v1_sms":"Max 160 chars. Data-driven. Ends with question.","v1_voice":"Call script: OPENING (name), ACKNOWLEDGE, SPECIFIC FACTS FROM SITUATION, REFRAME, OPEN QUESTION. Labelled.","v1_email_subject":"Subject under 9 words.","v1_email":"120-140 word email. Specific and personal. Ends with open question. Signed by ${ag}.","v2_label":"Empathy & Relationship","v2_whatsapp":"60-80 words. Warm, human, completely on their side. Ends with gentle open question.","v2_sms":"Max 160 chars. Empathetic. Ends with question.","v2_voice":"Call script: OPENING (name), DEEP ALIGNMENT, VALIDATE FULLY, SPECIFIC DETAIL SHOWING YOU LISTENED, GENTLE PIVOT, OPEN QUESTION. Labelled.","v2_email_subject":"Subject under 9 words. Warm.","v2_email":"120-140 word email. Empathy approach. Reference specific situation details. Never say 'another source of stress'. Ends with open question. Signed by ${ag}.","v3_label":"Urgency & Bold Reframe","v3_whatsapp":"60-80 words. Confident, honest, bold but never guilty. Reference their specific power. Ends with open question.","v3_sms":"Max 160 chars. Bold and direct. Ends with question.","v3_voice":"Call script: OPENING (name), BRIEF AGREEMENT, THEIR SPECIFIC POWER IN THIS SITUATION, WHAT THAT POWER MEANS FOR THEM, HONEST REFRAME, OPEN QUESTION. Labelled.","v3_email_subject":"Subject under 9 words. Bold.","v3_email":"120-140 word email. Confident and honest. Never guilt or other buyers as threat. Reference their specific advantage. Ends with open question. Signed by ${ag}."}`
 ...
 <div style={{marginTop:"12px"}}>
            <div style={{marginBottom:"12px"}}>
              ...
              <input type="text" placeholder="e.g. Met at a property expo last month, she mentioned she was actively searching for a 3-bed..." style={inp} value={s.introSourceContext||""} onChange={e=>update({introSourceContext:e.target.value})}/>
            </div>
            <Chips label="Urgency Level" options={URGENCY_EN} selected={s.urgency} onToggle={v=>update({urgency:v})} single/>
            <Chips label="Communication Tone" options={TONES_EN} selected={s.tone} onToggle={v=>update({tone:v})} single/>
 ...
 <div style={{marginTop:"12px"}}><label style={lbl}>What Do You Know About Their Property?</label>
            <div style={{marginBottom:"12px"}}>
              ...
              <input type="text" placeholder="e.g. Knocked on their door after seeing the property vacant for 3 months, they said they were thinking about selling..." style={inp} value={s.leadSourceContext||""} onChange={e=>update({leadSourceContext:e.target.value})}/>
            </div>
 ...
 {isObjection&&isBuyer()&&(
 <div style={card}>
 <h2 style={{fontSize:"17px",fontWeight:"700",marginBottom:"16px",color:"#fff"}}> Handle This Objection</h2>
 ...
 <textarea placeholder="e.g. We've had 3 conversations over 2 months. They were very interested initially but keep delaying. Wife wants to sell, husband is hesitant. Property has been on the market 60 days." rows={4} style={{...inp,resize:"vertical"}} value={s.objectionSituation||""} onChange={e=>update({objectionSituation:e.target.value})}/>
 </div>
 ...
 <h2 style={{fontSize:"17px",fontWeight:"700",marginBottom:"4px",color:"#fff"}}> Property Sold Nearby</h2>
 ...
 <div style={{paddingTop:"14px",borderTop:"1px solid #252530",marginTop:"8px"}}>
            <div style={{marginBottom:"12px"}}>
              ...
              <input type="text" placeholder="e.g. Agent did not respond to offers quickly, wrong photos..." style={inp} value={s.expiredReasonsOther||""} onChange={e=>update({expiredReasonsOther:e.target.value})}/>
            </div>
 ...
 {isFSBO&&(
 <div style={card}>
 <h2 style={{fontSize:"17px",fontWeight:"700",marginBottom:"4px",color:"#fff"}}> FSBO Outreach</h2>
 ...
 <div style={card}>
 <h2 style={{fontSize:"17px",fontWeight:"700",marginBottom:"16px",color:"#fff"}}> Your Details</h2>
 <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"12px",marginBottom:"12px"}}>
